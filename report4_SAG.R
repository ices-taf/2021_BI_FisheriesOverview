...
png("report/2020_BI_FO_SAG_Current_demersal.png",
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
#check this file name
png("report/2020_BI_FO_SAG_Current_pelagic.png",
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
#check this file name
png("report/2020_BI_FO_SAG_Current_crustacean.png",
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
#check this file name
png("report/2020_BI_FO_SAG_Current_benthic.png",
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
#check this file name
png("report/2020_BI_FO_SAG_Current_All_top10.png",
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
